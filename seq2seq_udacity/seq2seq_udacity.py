    ...
    for line in source_text.split("\n"):
        ...
        for word in line.split(" "):
            if word in source_vocab_to_int:
                line_int.append(source_vocab_to_int[word])
    ...
    for line in target_text.split("\n"):
        ...
        for word in line.split(" "):
            if word in target_vocab_to_int:
                line_int.append(target_vocab_to_int[word])
        line_int.append(target_vocab_to_int['<EOS>'])
...
def model_inputs():
    ...
    return (input_, targets, learning_rate, keep_probability)
...
def encoding_layer(rnn_inputs, rnn_size, num_layers, keep_prob):
    ...
    enc_cell = tf.contrib.rnn.DropoutWrapper(enc_cell, keep_prob, keep_prob)
...
def decoding_layer_train(encoder_state, dec_cell, dec_embed_input, sequence_length, decoding_scope,
    ...
    dec_cell = tf.contrib.rnn.DropoutWrapper(dec_cell, keep_prob, keep_prob)
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    for word in sentence.lower().split(" "):
        if word in vocab_to_int:
            ...
            id_sentence.append(vocab_to_int["<UNK>"])
    return id_sentence
